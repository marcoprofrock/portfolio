...
- ~~`500ls/index.html`~~ — Removed. The standalone prototype was folded into the live `index.html` `#p-500ls` block (see Architecture). The 13 fonts are kept under `assets/fonts/500ls/`.
